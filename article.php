...
$get_articles = $conn->prepare("SELECT pb_articles.id, pb_articles.author, pb_articles.title, pb_articles.summary, date_format(pb_articles.published, \"%Y-%m-%d %H:%i\") AS published, pb_articles.picture, pb_articles.content, pb_articles.link, pb_users.displayname, pb_users.username, pb_categories.title AS categoryname, pb_categories.link AS categorylink FROM pb_articles INNER JOIN pb_categories ON pb_articles.category = pb_categories.id INNER JOIN pb_users ON pb_articles.author = pb_users.id WHERE pb_articles.hidden=0 AND pb_articles.link=?");
        ...
        <div class="main-contents">
            ...
            <div class="articles-container">
                ...
                echo "<div class=\"article\">";
                    echo "<div class=\"article-header\"><h2>".htmlspecialchars($row["title"])."</h2>";
